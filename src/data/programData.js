...
export const CAPTURE_PROGRAMS = [
  ...
  {
    id: 'CP-002',
    name: 'Particle Physics Teaching Series',
    description: 'Expert teaching demonstrations for particle physics concepts — foundational through advanced.',
  ...
  },
  {
    ...
    description: 'Live think-aloud sessions of experts triaging CVEs and modeling real threat scenarios.',
...
export const COVERAGE_MATRIX = {
  ...
  'International Law':  { static_task: 44,  structured_problem: 18, process_narration: 6,  teaching_demo: 0,  retrospective_walkthrough: 6,  live_thinkaloud: 0 },
  'Particle Physics':   { static_task: 23,  structured_problem: 9,  process_narration: 0,  teaching_demo: 0,  retrospective_walkthrough: 0,  live_thinkaloud: 0 },
  'Cybersecurity':      { static_task: 0,   structured_problem: 0,  process_narration: 0,  teaching_demo: 0,  retrospective_walkthrough: 0,  live_thinkaloud: 0 },
}
